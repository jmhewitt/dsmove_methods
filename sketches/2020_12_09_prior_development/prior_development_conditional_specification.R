...
# want to set a normal prior on beta_loc, and specify a conditional distribution
# for the beta_ar... perhaps even a conditionally normal distribution here as 
# well?
# 
# so instead, we might want to consider setting a prior on the number of reversals
# and on the speed. with the way we set up our model, we do not need to specify
# a joint prior.  so, we might be recommending a partly empirical prior
