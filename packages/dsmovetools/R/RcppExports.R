...
TestDualSparseCoordVec <- function(x1, x2, v) {
    .Call('_dsmovetools_TestDualSparseCoordVec', PACKAGE = 'dsmovetools', x1, x2, v)
}

DepthLikEval <- function(dims, coords, obs_depths, zfield, zvals, ind) {
    .Call('_dsmovetools_DepthLikEval', PACKAGE = 'dsmovetools', dims, coords, obs_depths, zfield, zvals, ind)
}

GpsLikEval <- function(obs_lons, obs_lats, semi_majors, semi_minors, orientations, alpha, test_lon, test_lat, ind) {
    .Call('_dsmovetools_GpsLikEval', PACKAGE = 'dsmovetools', obs_lons, obs_lats, semi_majors, semi_minors, orientations, alpha, test_lon, test_lat, ind)
}
...
FFRWLightLogConstrainedSelfTxARCached <- function(a0, a0_prev_coords, log_a0val, dims, steps, surface_heights, domain_heights, log_self_tx, betaAR) {
    .Call('_dsmovetools_FFRWLightLogConstrainedSelfTxARCached', PACKAGE = 'dsmovetools', a0, a0_prev_coords, log_a0val, dims, steps, surface_heights, domain_heights, log_self_tx, betaAR)
}
...
SattagExpandNeighborhood <- function(a0, a0_prev_coords, log_a0val, gps_trunc_alpha, obs_lons, obs_lats, obs_semi_majors, obs_semi_minors, obs_orientations, obs_depth_bins, lon_gridvals, lat_gridvals, dims, surface_heights, domain_heights, obs_ind, nsteps) {
    .Call('_dsmovetools_SattagExpandNeighborhood', PACKAGE = 'dsmovetools', a0, a0_prev_coords, log_a0val, gps_trunc_alpha, obs_lons, obs_lats, obs_semi_majors, obs_semi_minors, obs_orientations, obs_depth_bins, lon_gridvals, lat_gridvals, dims, surface_heights, domain_heights, obs_ind, nsteps)
}
