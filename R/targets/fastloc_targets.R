    ...
    command = {
      ...
      ll = function(speed, betaAR, start_state = states[1,]) {
        ...
        dsmovetools2d:::SattagFilteredLL(
          ...
          gps_trunc_alpha = .05, 
          obs_lons = obs_gps$lon[1:1e3], 
          obs_lats = obs_gps$lat[1:1e3], 
          obs_semi_majors = obs_gps$semi_major[1:1e3], 
          obs_semi_minors = obs_gps$semi_minor[1:1e3], 
          obs_orientations = obs_gps$orientation[1:1e3], 
          obs_depths = obs_depths[1:1e3], 
          lon_gridvals = lons, 
          lat_gridvals = lats, 
